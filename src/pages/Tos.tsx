...
import { PUBLIC_WEBSITE_NAME, PUBLIC_WEBSITE_URL, CONTACT_EMAIL } from "../constants";
...
const Privacy: React.FC = () => (
  <Container>
    <h2>Welcome to {PUBLIC_WEBSITE_NAME}</h2>
    <p>
      These terms and conditions outline the rules and regulations for the use
      of {PUBLIC_WEBSITE_NAME}'s Website.
    </p>
    <br />
    <p>
      By accessing this website we assume you accept these terms and conditions
      in full. Do not continue to use {PUBLIC_WEBSITE_NAME}'s website if you do
    ...
    <h2>Cookies</h2>
    <p>
      We employ the use of cookies. By using {PUBLIC_WEBSITE_NAME}'s website you
      consent to the use of cookies in accordance with {PUBLIC_WEBSITE_NAME}'s
      privacy policy.
    </p>
    <p>
    ...
    <h2>License</h2>
    <p>
      Unless otherwise stated, {PUBLIC_WEBSITE_NAME} and/or it's licensors own
      the intellectual property rights for all material on {PUBLIC_WEBSITE_NAME}
      . All intellectual property rights are reserved. You may view and/or print
      pages from {PUBLIC_WEBSITE_URL} for your own personal use
      subject to restrictions set in these terms and conditions.
    </p>
    <p>You must not:</p>
    <ol>
      <li>Republish material from {PUBLIC_WEBSITE_URL}</li>
      <li>
    ...
    <p>
      Redistribute content from {PUBLIC_WEBSITE_NAME} (unless content is
    ...
    <ol>
      ...
      <li>
        ...
        areas of the website. {PUBLIC_WEBSITE_NAME} does not screen, edit,
        publish or review Comments prior to their appearance on the website and
        Comments do not reflect the views or opinions of {PUBLIC_WEBSITE_NAME},
        ...
        applicable laws {PUBLIC_WEBSITE_NAME} shall not be responsible or
      ...
      <li>
      {PUBLIC_WEBSITE_NAME} reserves the right to monitor all Comments and
        to remove any Comments which it considers in its absolute discretion to
      ...
      <li>
        You hereby grant to <strong>{PUBLIC_WEBSITE_NAME}</strong> a
        non-exclusive royalty-free license to use, reproduce, edit and authorize
    ...
    <p>
      ...
      {PUBLIC_WEBSITE_NAME}; and (d) where the link is in the context of general
    ...
    <p>
      ...
      e-mail to{" "}
      <a href={`mailto:${CONTACT_EMAIL}`} title={`send an email to ${CONTACT_EMAIL}`}>
        {CONTACT_EMAIL}
      </a>
    ...
    <ol>
      <li>By use of our organizational name; or</li>
      <li>
    ...
    <p>
      No use of {PUBLIC_WEBSITE_NAME}'s logo or other artwork will be allowed
